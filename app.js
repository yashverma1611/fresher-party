...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Check if admin is currently authenticated. If not, leave them
    // logged out — do NOT auto-grant a demo/admin session to visitors.
    ...
    if (scannerNameEl) {
        scannerNameEl.innerText = localStorage.getItem('event_admin_name') || 'Not signed in';
    }
